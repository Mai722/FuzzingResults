...
fairfuzzvariancedif <- cbind(fairfuzzvariancedif,Code=c("jpegtran"))


p <- ggplot(fairfuzzvariancedif,aes(x=fairfuzzvariancedif$Dif.varianzas, y=fairfuzzvariancedif$jpegtran))+
  geom_line( size=0.5)+ 
