...
fairfuzztiffsplitmax <- read.csv("C:/CVS/Maximo/fairfuzztiffsplitmax.csv", sep=";")


p<-ggplot(data=fairfuzztiffsplitmax, aes(x=Repetition, y=Bugs,label=Bugs), col= "black") +
